...
class QAPairGenerator:
    ...
    # def generate_from_file_structure(self, code_file: Dict) -> List[Dict]:
    #     """从文件结构生成问答对"""
    #     qa_pairs = []
    ...
    #     for template in self.qa_templates['business_logic']:
    #         question = template
    #         answer = f"文件{file_name}包含{len(code_file.functions)}个函数和{len(code_file.classes)}个类"
    #         qa_pairs.append({
    #             'question': question,
    #             'answer': answer,
    #             'type': 'file_structure',
    #             'context': {'file': file_name},
    #             'code_snippet': code_file.content,
    #             # 'reasoning': 
    #         })
        # return qa_pairs
...
class TrainingDataGenerator:
    ...
    def __init__(self):
        ...
        self.design_generator = DesignSolutionGenerator()
